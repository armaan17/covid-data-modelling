...
graph.py
  ...
  Compilation example: python cases_in_schoolboard_over_time_plot.py plot2.txt plot2.pdf
...
def main(argv):
    ...
    sns.lineplot(x = "Reported Date", y = "# of cases",data=csv_df)
    plt.title("Schoolboard Cases Over Time")
