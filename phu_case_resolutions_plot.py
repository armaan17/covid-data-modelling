...
graph.py
  ...
  Compilation Example: python phu_case_resolutions_plot.py plot3.txt plot3.pdf  
...
def main(argv):
    ...
    sns.lineplot(x = "Reported Date", y = "# of resolutions",data=csv_df)
    plt.title("PHU CASES RESOLUTIONS OVER TIME")
